            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-5">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Editar centro educatico</h4>
                                <p class="category">Complete los datos</p>
                            </div>
                            <div class="content">
                                <form method='post' action="${centro.id}/actualizar">
								<br>
                                     <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre" class="form-control border-input" placeholder="Nombre de centro educativo" value="${centro.nombre}" required>
                                                </div>
                                        </div>
                                    </div>
									<div class="row">
										<div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="direccion" class="form-control border-input" placeholder="Dirección" value="${centro.direccion}" required>
                                            </div>
                                        </div>
									</div>
